...
//Route::post('hello/add',  HelloController@add]); 教科書内ではこれ
//Route::get('hello/add',  HelloController@create]);教科書内ではこれ

Route::get('hello/edit',  [HelloController::class, 'edit']);
Route::post('hello/edit',  [HelloController::class, 'update']);
//Route::get('hello/edit',  HelloController@edit); 教科書内ではこれ
//Route::post('hello/edit',  HelloController@update);教科書内ではこれ

Route::get('hello/del',  [HelloController::class, 'del']);
Route::post('hello/del',  [HelloController::class, 'remove']);
//Route::get('hello/del',  HelloController@del); 教科書内ではこれ
//Route::post('hello/del',  HelloController@remove);教科書内ではこれ
